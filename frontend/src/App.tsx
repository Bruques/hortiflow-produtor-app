    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route element={<PrivateRoute />}>
          ...
          <Route path="/safras/:id/configuracoes/socios" element={<ConfiguracoesSociosPage />} />
          <Route path="/safras/:id/configuracoes/regras-despesa" element={<ConfiguracoesRegrasDespesaPage />} />
